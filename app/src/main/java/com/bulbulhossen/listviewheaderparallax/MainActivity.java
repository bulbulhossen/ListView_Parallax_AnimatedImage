...
public class MainActivity extends ActionBarActivity {
   ...
   // private int MAX_ROWS = 20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] data = new String[]{"Dhaka", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni", "Khulna", "Feni"};
        //int image[] = {R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher};


       // ListView townListView = (ListView) findViewById(R.id.listView);
        listView = (ListView) findViewById(R.id.listView);

        final ListAdapter ad = new ListAdapter(this, data);
